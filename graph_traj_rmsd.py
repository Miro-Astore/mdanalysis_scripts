...
#filelist=['_scratch_r16_ma2374_gmx_cftr_2nd_round_310K_I37R_3_rmsd.dat','_scratch_r16_ma2374_gmx_cftr_2nd_round_350K_I37R_2_rmsd.dat','_scratch_r16_ma2374_gmx_cftr_2nd_round_310K_R352Q_2_rmsd.dat','_scratch_r16_ma2374_gmx_cftr_2nd_round_310K_wt_2_rmsd.dat']
...
for i in range(len(label1)):
    ...
    data=np.loadtxt(filelist1[i])
    rmsd=data[:,-1]
    t=data[:,1]*0.001
    plt.plot(t,rmsd,label=label1[i])
